...
const ERROR_MESSAGES = new Map([
  ...
  ['source_oauth_scope_unsupported', 'Gorgias did not confirm the required ticket-read permissions. Authorization stopped before importing credentials.'],
  ...
  ['source_authentication_unsupported', 'The endpoint did not return supported MCP OAuth metadata or a standard discovery challenge.'],
