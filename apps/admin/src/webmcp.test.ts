...
function fixture(installationEnabled = true, onStateChange?: () => Promise<void>) {
  ...
  const team: Team = {
    ...
    pendingAction: null, proposedMembers: null, teams: [], proposedTeams: null,
  }
  ...
  const api = {
    ...
    prepareBigQueryRemoval: vi.fn(), removeSourceDraft: vi.fn(), saveSourceDraft: vi.fn<GatewayAdminApi['saveSourceDraft']>(async () => sources),
