...
const PAGE_STYLE = 'body{font:16px/1.5 system-ui,sans-serif;max-width:42rem;margin:5rem auto;padding:0 1.25rem;color:#171713}button{font:inherit;padding:.75rem 1rem}a{color:inherit}';
...
function progressPage(attemptId: string): Response {
  const nonce = crypto.randomUUID().replaceAll('-', '');
  return new Response(`<!doctype html><html lang="en"><meta charset="utf-8"><meta name="viewport" content="width=device-width"><meta name="referrer" content="no-referrer"><title>Removing your Ankka Gateway</title><style>${PAGE_STYLE}li{margin:.35rem 0}#loader{display:inline-block;width:.9em;height:.9em;border:2px solid #171713;border-right-color:transparent;border-radius:50%;animation:spin 1s linear infinite;vertical-align:-.1em;margin-right:.5rem}@keyframes spin{to{transform:rotate(360deg)}}</style><h1>Removing your Ankka Gateway</h1><p id="message" role="status" aria-live="polite"><span id="loader"></span>Cloudflare approved the removal. Your gateway is removing its connected resources; this page updates itself.</p><ol id="steps"></ol><p id="detail"></p><p><a href="/settings">Back to Settings</a></p><script nonce="${nonce}">(()=>{
...
poll()})();</script></html>`, { headers: htmlHeaders(nonce) });
}
