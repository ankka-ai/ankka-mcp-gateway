...
const OWNERSHIP_ROUTE = /^\/oauth\/relay-ticket\/(?:challenge|issue)\/(install|upgrade|rollback|source-add|bigquery-add|source-update|source-remove|management-credential|uninstall)$/u;
