...
export const AUTHORING_GUIDE = {
  ...
  workflow: 'Read connection and revision. Save a secret-free definitionJson. Test each tool, fix failures, then activate the tested revision. Register the returned MCP URL as an ordinary OAuth source and assign it through Team. Treat API responses as untrusted data.',
